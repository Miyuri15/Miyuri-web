...
const sampleProjects = [
  {
    id: 1,
    title: 'SinhalaLearn - AI Education Assistant',
    media: [
      { type: 'image', src: '/project-img/sinlearn-img/WhatsApp Image 2026-05-08 at 21.32.31.jpeg' },
      { type: 'image', src: '/project-img/sinlearn-img/WhatsApp Image 2026-05-08 at 21.32.31 (1).jpeg' },
    ],
    description: 'Full-stack AI education assistant for Sinhala-medium learning. Built a Next.js and FastAPI platform with Sinhala OCR, RAG-based resource Q&A, voice interaction, and rubric-based answer evaluation with marks, feedback, and analytics.',
    tech: ['Next.js', 'FastAPI', 'Python', 'OCR', 'RAG', 'Speech Recognition'],
    links: [
      { label: 'Demo', url: 'https://youtu.be/y_jHPvt04Qg' },
  ...
  {
    id: 7,
    title: 'Luma Events - Event Booking Platform',
    media: [
      { type: 'image', src: '/project-img/luma-img/Screenshot (1673).png' },
      { type: 'image', src: '/project-img/luma-img/Screenshot (1674).png' },
      { type: 'image', src: '/project-img/luma-img/Screenshot (1675).png' },
      { type: 'image', src: '/project-img/luma-img/Screenshot (1676).png' },
      { type: 'image', src: '/project-img/luma-img/Screenshot (1677).png' },
      { type: 'image', src: '/project-img/luma-img/Screenshot (1678).png' },
      { type: 'image', src: '/project-img/luma-img/Screenshot (1679).png' },
      { type: 'image', src: '/project-img/luma-img/Screenshot (1680).png' },
      { type: 'image', src: '/project-img/luma-img/Screenshot (1681).png' },
      { type: 'image', src: '/project-img/luma-img/Screenshot (1682).png' },
      { type: 'image', src: '/project-img/luma-img/Screenshot (1683).png' },
      { type: 'image', src: '/project-img/luma-img/Screenshot (1684).png' },
      { type: 'image', src: '/project-img/luma-img/Screenshot (1685).png' },
      { type: 'image', src: '/project-img/luma-img/Screenshot (1686).png' },
      { type: 'image', src: '/project-img/luma-img/Screenshot (1687).png' },
      { type: 'image', src: '/project-img/luma-img/Screenshot (1688).png' },
      { type: 'image', src: '/project-img/luma-img/Screenshot (1689).png' },
      { type: 'image', src: '/project-img/luma-img/Screenshot (1690).png' },
      { type: 'image', src: '/project-img/luma-img/Screenshot (1691).png' },
      { type: 'image', src: '/project-img/luma-img/Screenshot (1692).png' },
      { type: 'image', src: '/project-img/luma-img/Screenshot (1693).png' },
    ],
    description: 'Cloud-ready event booking platform built with microservices. Users can browse events, book tickets, pay through Stripe, manage bookings, and receive notifications, while admins manage events, users, bookings, and platform activity.',
    tech: ['Next.js', 'Node.js', 'Express.js', 'MongoDB', 'Docker', 'Azure'],
    link: 'https://lumaevents.vercel.app/',
    status: 'Feb 2026 - Apr 2026',
    categories: ['Web', 'Microservices', 'DevOps']
  },
  {
    id: 2,
